...
class CaseDuplicates(models.Model):
    ...
    created_by = models.ForeignKey(AppUser, null=True, related_name='creator', on_delete=models.CASCADE)
    created_at = models.DateTimeField(default=timezone.now)
    updated_by = models.ForeignKey(AppUser, null=True, related_name='updator', on_delete=models.CASCADE)
