...
class CaseDuplicates(models.Model):
    ...
    organization_unit = models.ForeignKey(RegOrgUnit, on_delete=models.CASCADE)
    case = models.ForeignKey(OVCCaseRecord, on_delete=models.CASCADE)
    created_by = models.ForeignKey(AppUser, on_delete=models.CASCADE, null=True, related_name='creator')
    created_at = models.DateTimeField(default=timezone.now)
    updated_by = models.ForeignKey(AppUser, on_delete=models.CASCADE, null=True, related_name='updator')
