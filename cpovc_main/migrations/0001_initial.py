    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('form_subject_id', models.IntegerField(blank=True, null=True)),
                ('form_area_id', models.IntegerField(blank=True, null=True)),
                ('date_began', models.DateField(null=True)),
                ('date_ended', models.DateField(blank=True, null=True)),
                ('date_filled_paper', models.DateField(null=True)),
                ('person_id_filled_paper', models.IntegerField(blank=True, null=True)),
                ('org_unit_id_filled_paper', models.IntegerField(blank=True, null=True)),
                ('capture_site_id', models.IntegerField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area_type_id', models.CharField(max_length=50)),
                ('area_code', models.CharField(max_length=10, null=True)),
                ('parent_area_id', models.IntegerField(blank=True, null=True)),
                ('is_void', models.BooleanField(default=False)),
            ],
            options={
