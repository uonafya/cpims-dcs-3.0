...
class TestUrls(SimpleTestCase):
     ...
     def test_view_case_record_sheet(self):
         ...
         self.assertEqual(resolve(url),views.view_case_record_sheet)
     def test_edit_case_record_sheet(self):
         url=reverse('edit_case_record_shhet',args=[1])
         self.assertEqual(resolve(url),views.edit_case_record_sheet)
     def test_delete_case_record_sheet(self):
         url=reverse('delete_case_record_sheet')
         self.assertEqual(resolve(url),views.delete_case_record_sheet)
     ...
     def test_new_alternative_family_care_urls(self):
         url = reverse('alternative_family_care',args=[1])
         self.assertEqual(resolve(url).func, views.alternative_family_care)
     ...
     def test_edit_placements(self):
         ...
         self.assertEqual(resolve(url), views.edit_placement)

     def test_delete_placement(self):
         url = reverse('delete_placement', args=[1])
         self.assertEqual(resolve(url), views.delete_placement())

     def test_residential_placement(self):
         url = reverse('residential_placement')
         self.assertEqual(resolve(url), views.residential_placement)